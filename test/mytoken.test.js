...
contract('ERC20', function (accounts) {
  ...
  beforeEach(async function () {
    ...
    this.token.mint(initialHolder,new BN(100))
  });
  ...
  describe('burn', function () {
    ...
    // }); сжигать можно только со своего аккаунта
    ...
    describe('for a non zero account', function () {
      ...
      const describeBurn = function (description, amount) {
        describe(description, function () {
          beforeEach('burning', async function () {
            //console.log(await this.token.balanceOf(initialHolder))
      ...
      describeBurn('for less amount than balance', initialSupply);
    });
  });
  ...
  //     return this.token.approve(owner, spender, amount);
  //   });

  //   describe('when the owner is the zero address', function () {
  //     it('reverts', async function () {
  //       await expectRevert(this.token.approve(ZERO_ADDRESS, recipient, initialSupply),
